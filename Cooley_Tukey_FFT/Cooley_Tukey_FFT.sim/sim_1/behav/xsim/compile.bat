...
REM
REM Generated by Vivado on Sat May 30 15:11:40 +0200 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_fft_top_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_fft_top_vlog.prj -log xvlog.log
