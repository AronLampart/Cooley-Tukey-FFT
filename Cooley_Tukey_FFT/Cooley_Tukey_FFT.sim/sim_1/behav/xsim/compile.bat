...
REM
REM Generated by Vivado on Mon May 25 18:19:15 +0200 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_fft_top_structural_beh_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_fft_top_structural_beh_vlog.prj -log xvlog.log
